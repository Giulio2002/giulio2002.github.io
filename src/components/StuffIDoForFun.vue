...
<div class="container">
    <div class="flex-item big centered">
        ...
        <div class="text">
            <h6>Fuck this is going to take time...</h6>
        <br>
        <br>
        <h3>Bullshit #1</h3>
        <br>
        ...
        <ul>
            ...
            <li><a href="https://github.com/torquem-ch/silkworm">Silkworm</a>: Implemented many of the currently existing syncing component and took care of ETL framework integration.</li>
            <li><a href="https://github.com/sigp/lighthouse/commits?author=Giulio2002">Akula</a>: Implemented Akula JSON-RPC.</li>
